...
import useObtenerDetallesWinUser from "../../../hook/userObtenerDetallesWinUser";
export default function ModalPremiosByUser({
  isOpen,
  onOpenChange,
  desde,
  hasta,
  ...
  const { data, loading, error } = useObtenerDetallesWinUser(
    desde,
    hasta,
    email
  );
          ...
          {(onClose) => (
            <>
              <ModalHeader className="flex flex-col gap-1 text-center">
                Premios desde {desde} hasta {hasta}
              </ModalHeader>
              <ModalBody>
